...
abstract class CachableModel extends Model
{
	...
	{
		parent::find(self::prepareParameters($parameters)); // TODO: Change the autogenerated stub
	}
	...
	private static function prepareParameters($parameters = null)
	{
		...
		if (self::isCachable() && $di->has('modelsCache')) {
			$cache_key = Kernel::createCacheKey($parameters);
	...
	{
		parent::findFirst(self::prepareParameters($parameters));
	}
