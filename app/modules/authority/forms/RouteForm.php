...
class RouteForm extends Form
{
	...
	{
		parent::getValue($name); // TODO: Change the autogenerated stub
		if(strpos('start_st',$name)===0 || strpos('end_st',$name)===0){
			$var_path=$this->_entity->path;
			if (key_exists($name,$var_path)){
