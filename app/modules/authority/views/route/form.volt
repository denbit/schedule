	...
	<script>
		...
		$(document).ready(function () {
			...
			function add_transit(i) {
				var block = `<tr class="data">
								<td><input type="text" class="city from form-control" name="start_st${i}"></td>
								<td><input type="time" class="form-control" name="start_time${i}"></td>
								<td><input type="text" class="city to form-control" name="end_st${i}"></td><td>
				...
				$(end).val($(prev_end).val());
				$(end).attr('data-value', $(prev_end).attr('data-value')).prop('readonly', true);
				$(prev_end).val('');
