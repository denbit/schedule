...
<header class="top_fixed">
    <nav class="justify-content-start navbar navbar-expand-sm navbar-light">
        ...
        <div class="navbar-collapse">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item mx-5 dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="currency" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{ currency|default("UAH") }}</a>
    ...
    <h2 class="text-center my-5 text-white">Transportation, schedule and ticket control system<br>{{ subtitle|default("Main") }}</h2>
</header>
