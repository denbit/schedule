...
CREATE TABLE IF NOT EXISTS `company` (
  ...
  PRIMARY KEY (`id`),
  KEY `company_users_id_fk` (`user`),
  CONSTRAINT `company_users_id_fk` FOREIGN KEY (`user`) REFERENCES `users` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

-- Zrzucanie danych dla tabeli raspis00_test.company: ~3 rows (około)
/*!40000 ALTER TABLE `company` DISABLE KEYS */;
INSERT INTO `company` (`id`, `name`, `cyr_name`, `latin_name`, `address`, `cyr_address`, `latin_address`, `judicial_form`, `user`) VALUES
